...
NOTE: removed QX1211 because those wells should be empty - all wells but 1 got removed by the filters
```{r}
#remove wells
...
H^2 = 627.87/(627.87+555.70) = 53.05%
{old value when cl dataframe was not passed to next step as it should have been: H^2 = 654.97/(654.97+535.37) = 55.02% }
```{r}
#mixed model 
